...
namespace com.bemaservices.Jobs.Migrations
{
	...
	public class UpdateSystemEmail : Migration
	{
		...
		public override void Up()
		{
			...
			// Update the system Email
			Sql( @"
			UPDATE [SystemEmail] SET Body = '<style>
...
{{ ''Global'' | Attribute:''EmailFooter'' }}', CategoryId = (SELECT [Id] From Category
			WHERE [Name] = 'Plugin') WHERE Guid = 'A1911882-19DD-4197-A8D8-63CBD8A7D80B';
" );
